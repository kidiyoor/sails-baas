...
module.exports = (function () {
  ...
  var adapter = {
    ...
    describe: function (connection, collection, cb) {
      ...
      util.describe(connection, collection, function(err, data){
        if(err) return cb(err);
        return cb(null, data);
      });
    ...
    find: function (connection, collection, options, cb) {
			util.find(connection, collection, options, function(err, data){
        if(err) return cb(err);
        return cb(err, data);        
      });
    },
    ...
    create: function (connection, collection, values, cb) {
      util.create(connection, collection, values, function(err, data){
        if(err) return cb(err);
        return cb(err, data);        
      });
    },
    ...
    update: function (connection, collection, options, values, cb) {
      util.update(connection, collection, options, values, function(err, data){
        if(err) return cb(err);
        return cb(null, data);
      });
    },
    ...
    destroy: function (connection, collection, options, cb) {
      util.destroy(connection, collection, options, function(err, data){
        if(err) return cb(err);
        return cb(null, data);
      });
    }
